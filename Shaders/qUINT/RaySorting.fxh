...
uint permute_frame_index(in uint framecounter)
{
    ...
    int permutation_table[RAY_SORTING_FRAME_HISTORY_SIZE] = {0, 4, 2, 6, 1, 5, 3, 7};
#elif RAY_SORTING_FRAME_HISTORY_SIZE == 4
    int permutation_table[RAY_SORTING_FRAME_HISTORY_SIZE] = {0, 2, 1, 3}; 
#elif RAY_SORTING_FRAME_HISTORY_SIZE == 3
    int permutation_table[RAY_SORTING_FRAME_HISTORY_SIZE] = {0, 1, 2}; //not a power of two, works fine
#elif RAY_SORTING_FRAME_HISTORY_SIZE == 2
    int permutation_table[RAY_SORTING_FRAME_HISTORY_SIZE] = {0, 1};
#else //RAY_SORTING_FRAME_HISTORY_SIZE == 1
    int permutation_table[RAY_SORTING_FRAME_HISTORY_SIZE] = {0};
#endif
                        ...
                        in float random_seed)
{
    ...
    uint permuted_pixel = random_seed * RAY_SORTING_PIXEL_GRID_DIM_2 + 1;
